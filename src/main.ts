...
const TAB_INTRO: Partial<Record<SubTab, string>> = {
  ...
  'Geweihte': 'Zeigt Geweihtengrad, Karma-Pool-Punkte (KPP) und die verfügbaren Wunder der gewählten Religion. Die Fähigkeiten Stoßgebet/Wunder/Ritual (Probe-Basis) werden direkt hier gesteigert.',
};
    ...
    <header class="app-header">
      ...
      ${sheet ? `
        <div class="budget-bar">
          ...
          <span title="Summe der Kaufpreise aller aktuell besessenen Ausrüstung einschließlich Anzahl und Rüstungsteilen">Wert der Ausrüstung: <span class="numeric-field-output numeric-field-formatted-five">${formatDublonenNumber(sheet.dublonenSpent)}</span> D</span>
        </div>` : ''}
